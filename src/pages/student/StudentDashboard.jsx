...
const StatCard = ({ icon: Icon, label, value, color = 'primary', onClick, sublabel }) => (
  ...
  >
    <div
      className={`w-10 h-10 sm:w-11 sm:h-11 rounded-xl flex items-center justify-center flex-shrink-0 transition-transform duration-200 group-hover:scale-105 mb-3 ${
        color === 'primary'
